...
import { approveBid, getBidsBySellerId, sellerLogout } from '../../Utilities/Sellers';
...
export default function Customer() {
  ...
  const Items = () => {
    React.useEffect(()=>{
      getBidsBySellerId(sessionStorage.getItem('sellerId')).then(items => setBids(items))
    },[])
    ...
    return (<TableContainer component={Paper}>
      <Table aria-label="simple table">
          ...
          {bids.map((row) => (
              ...
              <TableCell align="right">Rs {row.bidVal}</TableCell>
              {(row.status == 'open') && <TableCell align="right"><Button variant='contained' onClick={()=>{
                approveBid(row._id)
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            <IconButton color="inherit" onClick={sellerLogout}><LogoutIcon/></IconButton>
            </Toolbar>
        </AppBar>
